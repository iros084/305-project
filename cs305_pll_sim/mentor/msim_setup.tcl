...
# ----------------------------------------
# If cs305_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2024.05.22.13:50:09
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cs305_pll.vho"
}
